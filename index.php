...
<?php include"top_nav.php";?>
    ...
    <div class="container">
			 ...
			 <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <p>...<br>
						<a href=" " class="btn btn-primary">Owner Login</a>
						<a href="hospitals.php" class="btn btn-primary">User Login</a>
                    </div>
                </div>
            </div>
			  ...
			  <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <p>...<br>
						<a href=" " class="btn btn-primary">Owner Login</a>
						<a href="doctors.php" class="btn btn-primary">User Login</a>
                    </div>
                </div>
            </div>
      ...
      <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header  text-primary">Porfolio</h2>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header  text-primary">Features about E-Medicare</h2>
            </div>
            <div class="col-md-6">
